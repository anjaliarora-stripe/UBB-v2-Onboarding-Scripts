...
def create_pricing_plan_and_subscription(plan_number):
    ...
    try:
        ...
        # ============================================================================
        # STEP 5b: Create Service Action (Free Credits)
        # ============================================================================
        print("\n[5b/11] Creating Service Action (Welcome Credits)...")
        
        service_action_response = client.raw_request(
            "post",
        ...
        service_action = client.deserialize(service_action_response, api_mode='V2')
        ids['service_action_id'] = service_action.id
        print(f"  ✓ Service Action Created: {service_action.id}")
        print(f"  ✓ Grants $10.00 in credits every month")
        ...
        # Attach Service Action
        print(f"  • Attaching Service Action...")
        
        service_action_component_response = client.raw_request(
            "post",
            f"/v2/billing/pricing_plans/{pricing_plan.id}/components",
            type="service_action",
            service_action={
        ...
        print(f"  ✓ Service Action Attached to Pricing Plan")
        ...
        print(f"  • Service Action:  {ids['service_action_id']}")
